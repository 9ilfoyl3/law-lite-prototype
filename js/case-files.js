...
function generateMockDocument(caseData, orgType, docTypeName, templateName, elementAnswers, templateContent, workflowId) {
    ...
    if (sections.length > 0) {
        ...
        // C 类：空模板回退默认 4 段结构（含法条引用，便于演示文书精修页"法条链接 Ctrl+点击查看"功能）
        bodyHtml = `<h3>一、案件基本情况</h3>
            <p>经审理查明，${partyA}与${partyB}因${cause}产生纠纷。根据已选材料分析，案件基本事实如下...</p>
            <h3>二、证据分析</h3>
            <p>根据当事人提交的证据材料，本院对证据的真实性、合法性、关联性进行了审查...</p>
            <h3>三、本院认为</h3>
            <p>本院认为，本案的争议焦点在于${cause}的相关事实认定和法律适用。行为人因过错侵害他人民事权益造成损害的，应当依照《中华人民共和国民法典》第一千一百六十五条之规定承担侵权责任。结合本案证据与事实，对原告诉讼请求及被告答辩内容逐一分析认定...</p>
            <h3>四、判决/决定结果</h3>
            <p>综上，依照《中华人民共和国民法典》第一千一百六十五条、第一千一百七十九条、第一千一百八十三条、第一千二百零八条，《中华人民共和国道路交通安全法》第七十六条，《中华人民共和国民事诉讼法》第一百六十二条之规定，本院作出如下判决/决定...</p>`;
    }
...
function applyTemplateContent(templateContent, ctx) {
    ...
    const complexRules = [
        ...
        [/\[从法院角度[^\]]*\]/g, `本院认为，本案的争议焦点在于${cause}的相关事实认定和法律适用。行为人因过错侵害他人民事权益造成损害的，应当依照《中华人民共和国民法典》第一千一百六十五条之规定承担侵权责任。结合本案证据与事实，对原告诉讼请求及被告答辩内容逐一分析认定……`],
        [/\[结合本案事实及法律法规[^\]]*\]/g, '结合本案事实及《中华人民共和国民法典》《中华人民共和国民事诉讼法》等相关法律法规进行综合论述'],
        // 模板原文为"依照《[相关法律法规及条款]》之规定"，替换值吃掉尾部》避免重复
        [/\[相关法律法规及条款\]》/g, '中华人民共和国民法典》第一千一百六十五条、第一千一百七十九条、第一千一百八十三条、第一千二百零八条，《中华人民共和国道路交通安全法》第七十六条，《中华人民共和国民事诉讼法》第一百六十二条'],
        [/\[相关法律法规及条款\]/g, '《中华人民共和国民法典》第一千一百六十五条、第一千一百七十九条、第一千一百八十三条、第一千二百零八条，《中华人民共和国道路交通安全法》第七十六条，《中华人民共和国民事诉讼法》第一百六十二条'],
        [/\[判决主文第一项\]/g, '……'],
        [/\[判决主文第二项\]/g, '……'],
        [/\[XXX\]/g, 'XXX'],
